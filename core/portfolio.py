...
class Portfolio(object):
    def __init__(self, num_sources, initial_wealth, name):
        assert(num_sources > 0, 'number of sources must be greater than 0')
    ...
    def update_wealth(self, win_index, odds):
        ...
        self.__print_info(safe_wealth, amount_won, net_wealth_change_pct)

    def __print_info(self, safe_wealth, amount_won, net_wealth_change_pct):
